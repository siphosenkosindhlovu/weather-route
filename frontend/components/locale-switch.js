...
const LocaleSwitch = ({ pageContext }) => {
  ...
  return (
    <div ref={select} className="relative ml-4 ">
      <button
        type="button"
        className="hover:bg-primary-50 hover:text-green-primary focus:bg-primary-50 focus:text-green-primary focus:outline-none flex items-center justify-between px-2 py-2 cursor-pointer h-full rounded-md w-20"
        onClick={() => setShowing(!showing)}
      >
        <WorldIcon />
        <span className="capitalize">{locale}</span>
        <MdExpandMore className="ml-1 text-green-primary" />
      </button>
      <div
            ...
            return (
              ...
              >
                <p
                  ...
                  className="capitalize hover:bg-primary-50 cursor-pointer p-2 rounded-md text-center hover:text-green-primary"
                >
                  {locale}
                </p>
              </Link>
